//——————————————————————————————————————————————————————————————————————————————
//  ACAN2515 Demo in normal mode,RECEIVE ECU 3
//——————————————————————————————————————————————————————————————————————————————
...
//--- Begin SPI
  ...
  const ACAN2515Mask rxm0 = extended2515Mask (0x00000000) ; // For filter #0 and #1
//  const ACAN2515Mask rxm1 = standard2515Mask (0x7F0, 0xFF, 0) ; // For filter #2 to #5
  const ACAN2515AcceptanceFilter filters [] = {
    {extended2515Filter (0x333C333), receive0},
  } ;
...
CANMessage inmsg; 
  ...
  //can.dispatchReceivedMessage () ;
     Serial.println();
      Serial.print ("Receive3Frame_id: ") ;
     Serial.print(inmsg.id,HEX);
     Serial.print ("    Received3_SentFrameCount: ") ;
