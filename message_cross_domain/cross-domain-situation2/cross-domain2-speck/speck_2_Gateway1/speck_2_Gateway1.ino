...
//--- Begin SPI
  ...
  const ACAN2515AcceptanceFilter filters [] = {
    {extended2515Filter (0x8200021 ), receive0},
    { extended2515Filter (0x4280041), receive0},
  }; 
...
//      if((frame.id&0X1c1800e0)== 0X8000020){
//        frame.id = 0X8280121;
...
//        }
//      }
//      else if((frame.id&0X1c1800e0)==0x4080040){
//        frame.id = 0X4300141;
//        const bool ok= can.tryToSend (frame) ;
//        if(ok){
//         Serial.print("after reply RTR_id:");
...
//       Serial.println(frame.id);
//       if((frame.id&0x1c1800e0)==0x4080040){
//        frame.id = 0x8200121;
//        const bool ok= can.tryToSend (frame) ;
//        if(ok){
...
//        }
//      }
//      else if((frame.id&0x1c1800e0)==0X8000020){
//        frame.id=0x8280121;
//        const bool ok= can.tryToSend (frame) ;
//        if(ok){
//          Serial.print("after reply DATA_id:");
...
//        }else{
//          Serial.println ("-----------------Mega1 reply DATA to getaway list failure---------------") ;
//        }
//      }
//     }
//   }
...
//------------------------------------------------Receive RTR----------------------------------------------
    if(frame_cipher_or_rtr.rtr==true){
      ...
      if((frame_cipher_or_rtr.id&0X1c1800e0)==0X8000020){
        frame_cipher_or_rtr.id = 0xbee0021;
...
//      }
        ...
        frame_cipher_or_rtr.id = 0X7f60041;
        frame_mac.id = frame_cipher_or_rtr.id;
        //----------------------------------send_RTR-------------------------------------
        const bool ok_cipher_or_rtr = can.tryToSend (frame_cipher_or_rtr) ;
        const bool ok_mac = can.tryToSend (frame_mac) ;
