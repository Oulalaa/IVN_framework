...
//--- Begin SPI
  ...
  const ACAN2515AcceptanceFilter filters [] = {
    {extended2515Filter (0x0160021), receive0},//跨域RTR 
    {extended2515Filter (0x0128042), receive0},//域内RTR 
    {extended2515Filter (0x0060041), receive0},//跨域DATA 
    {extended2515Filter (0x0028041), receive0},//域内DATA 
  }; 
