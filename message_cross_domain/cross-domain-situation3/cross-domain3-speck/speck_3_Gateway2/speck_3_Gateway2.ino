...
//      if(ok){
//        Serial.println ("-----------------Mega2 reply to own domain succeed---------------") ;
//      }else{
//        Serial.println ("-----------------Mega2 reply to own domain failure---------------") ;
//      }
//    }
//    else{
//      frame.id=0x4280141;
...
//        Serial.println(frame.id);
//        Serial.println ("-----------------Mega2 reply to getaway list succeed---------------") ;
//      }else{
//        Serial.println ("-----------------Mega2 reply to getaway list fail---------------") ;
//      }
//    }
//   }
   ...
   if(can.available()){
    ...
    if((frame_cipher.id&0x1c000000)==0x8000000){
    ...
    //----------------------------------send_mac-------------------------------------   
      ...
      if(ok_cipher&&ok_mac){
        Serial.print("after_domian_frame.id:");
        Serial.println(frame.id);
        Serial.println ("-----------------Mega2 reply to own domain succeed---------------") ;
      }else{
        Serial.println ("-----------------Mega2 reply to own domain failure---------------") ;
