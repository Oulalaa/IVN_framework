...
//--- Begin SPI
  ...
  const ACAN2515AcceptanceFilter filters [] = {
    ...
    {extended2515Filter (0x8300121), receive0},//跨域RTR 0x8300121
    {extended2515Filter (0x8300142), receive0},//域内RTR 0x8300142
    {extended2515Filter (0x4200141), receive0},//跨域DATA 0x4200141
    {extended2515Filter (0x8400141), receive0},//域内DATA 0x8400141
  }; 
...
//------------------------------------------------Receive RTR----------------------------------------------
    if(frame_cipher_or_rtr.rtr==true){
      if(frame_cipher_or_rtr.id==0X8300121){
        frame_cipher_or_rtr.id = 0x4200141;
      ...
      else if(frame_cipher_or_rtr.id==0X8300142){
